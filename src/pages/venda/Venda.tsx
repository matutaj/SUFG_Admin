...
import Print from 'components/icons/factor/Print';
...
const Venda = () => {
  ...
  const validateDates = (start: string, end: string) => {
    if (start && end && start > end) {
      setError({
        startDate: 'A data de início não pode ser maior que a data de fim.',
        endDate: 'A data de fim não pode ser menor que a data de início.',
      });
    } else {
